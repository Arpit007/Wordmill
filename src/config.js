...
var config = {
    ...
    +'&includeRelated=false&useCanonical=false&includeTags=false&api_key=dcb5aeccb2a3438a7c00605c22f04e16a618f8c7512af537c',
    
    ExtrasUrl : 'http://api.wordnik.com/v4/word.json/${Word}/relatedWords?useCanonical=false&limitPerRelationshipType=10'
    + '&api_key=dcb5aeccb2a3438a7c00605c22f04e16a618f8c7512af537c'
};
